...
window.AIXIS = {
  ...
  GRADES: [
    { min: 4.5, grade: 'S', label: 'S', color: '#DDC67D' },
    { min: 3.8, grade: 'A', label: 'A', color: '#B5CCDE' },
    { min: 3.0, grade: 'B', label: 'B', color: '#9DB9AD' },
    { min: 2.0, grade: 'C', label: 'C', color: '#B9ABA0' },
    { min: 0,   grade: 'D', label: 'D', color: '#B98D8D' }
  ],
